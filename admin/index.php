        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-sm-6 mb-4 mb-xl-0">
              <h4 class="font-weight-bold text-dark">Upload website logo from here.</h4>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group col-xs-12">
                      ...
                      <span class="input-group-append">
                        <button type="submit" name="upload" class="file-upload-browse btn btn-primary" >Upload</button>
                      </span>
                    </div>
                  </div>
