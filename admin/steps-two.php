<?php 
include('header.php');
include('handler/stepsTwoHandler.php');
...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        <h4 class="font-weight-bold text-dark">Site Home Steps Two from here.</h4><br>
            ...
            <form action="" method="post" class="forms-sample" enctype="multipart/form-data">               
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea class="form-control" id="about" name="content" placeholder="Type steps content...." rows="4"><?php echo $showContent2; ?></textarea>
                    </div>
                </div>
                ...
                <button type="submit" name="steps_two" class="btn btn-primary btn-rounded btn-fw">Save Changes</button>
