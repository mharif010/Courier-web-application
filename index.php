                    ...
                    <div class="theme-container container">  
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">   
                                ...
                                <h2 class="section-title pb-10 wow fadeInUp own-bgGradient" data-wow-offset="50" data-wow-delay=".20s" > calculate your cost </h2>
                                ...
                                <div class="calculate-form">
                                    ...
                                    <div class="pricing-condition"> 
                                        <p><i class="fa fa-check-square-o" aria-hidden="true"></i> 1% Cash Handling &amp; Risk Management Charge will be added. </p> 
                                        <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Price may vary due to parcel size. </p> 
                                        <p><i class="fa fa-check-square-o" aria-hidden="true"></i> All charges are VAT &amp; Tax excluded.  </p> 
                                        <p><i class="fa fa-check-square-o" aria-hidden="true"></i> Unavoidable circumstances may change in time of delivery.</p>
                                    </div>
